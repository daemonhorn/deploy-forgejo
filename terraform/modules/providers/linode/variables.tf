...
variable "region" {
  description = "Linode region slug (e.g. 'us-east' = Newark, 'us-southeast' = Atlanta). See: linode.com/global-infrastructure/"
  type        = string
}

variable "plan" {
  description = "Linode instance type slug (e.g. 'g6-nanode-1'). See: linode.com/pricing/"
  type        = string
}
